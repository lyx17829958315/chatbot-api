package cn.xynu.chatbot.api.application.ext;

import cn.xynu.chatbot.api.application.job.ChatbotTask;
import cn.xynu.chatbot.api.common.PropertyUtil;
import cn.xynu.chatbot.api.domain.ai.IOpenAI;
...
public class TaskRegistrarAutoConfig implements EnvironmentAware, SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        ...
        for (String groupKey : taskGroups) {
            ...
            String cronExpression = new String(Base64.getDecoder().decode(cronExpressionBase64.replace("\r\n", "")), StandardCharsets.UTF_8);
